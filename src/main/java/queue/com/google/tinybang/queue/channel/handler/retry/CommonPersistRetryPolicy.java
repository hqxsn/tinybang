 ...
 * <li> JMX supports to handle the maunally retry.
 * @author <a href="mailto:wz.xjtu@gmail.com">wenzhong</a>
 * Sep 29, 2010
 */
public class CommonPersistRetryPolicy extends SimpleDownStreamHandler {
	...
	public String getName() {
		return CommonPersistRetryPolicy.class.getSimpleName();
	}
...
//			// persist the data to the data for the further usage.
//		} else {
